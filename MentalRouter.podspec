#
#  Be sure to run `pod spec lint MentalRouter.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
                      ...
                      DESC
  spec.homepage     = "https://github.com/MsMobileDev/MentalRouter.git"
  ...
  spec.source       = { :git => "https://github.com/MsMobileDev/MentalRouter.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "MentalRouter/**/**/*.swift"
